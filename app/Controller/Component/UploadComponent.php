<?php
	...
	class UploadComponent extends Component{
		...
		/**
		  ...
		  *
		  *
		  *		$destination = 'img/online_mutual_fund/';
		  *		$file = $this->data['ModelName']['field_name'];

		  *		// upload the image using the upload component
		  *		$result = $this->Upload->upload($file, $destination, null, array('type' => 'resizecrop', 'size' => array('200', '100'), 'output' => 'jpg'));
		  *		if (!$result){
		  *			$this->data['ModelName']['field_name'] = $this->Upload->result;
		  *		}
		  *
		  */
